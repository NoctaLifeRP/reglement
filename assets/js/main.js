!(function (e) {
    ...
    if (
        (e(window).on("load", function () {
            e(".tg-preloader").delay(0).fadeOut(),
                e(".slider-active")
                    .slick({ autoplay: !1, autoplaySpeed: 1e4, dots: !1, fade: !0, arrows: !1, responsive: [{ breakpoint: 767, settings: { dots: !1, arrows: !1 } }] })
                    .slickAnimation(),
    ...
    e("[data-background]").each(function () {
        ...
        s.scroll(function () {
            var e = s.scrollTop();
            e >= i ? t.addClass("tg-sticky-menu") : (t.removeClass("tg-sticky-menu"), t.removeClass("sticky-menu__show")),
    ...
    if (
        ...
        new Swiper(".trendingNft-active", {
            ...
            slidesPerView: 3,
            spaceBetween: 30,
            breakpoints: { 1500: { slidesPerView: 3 }, 1200: { slidesPerView: 3 }, 992: { slidesPerView: 2 }, 768: { slidesPerView: 2 }, 576: { slidesPerView: 1 }, 0: { slidesPerView: 1 } },
            navigation: { nextEl: ".slider-button-next", prevEl: ".slider-button-prev" },
        }),
        new Swiper(".streamers-active", {
            ...
            slidesPerView: 5,
            spaceBetween: 20,
            breakpoints: { 1500: { slidesPerView: 5 }, 1200: { slidesPerView: 4 }, 992: { slidesPerView: 4 }, 768: { slidesPerView: 3 }, 576: { slidesPerView: 2 }, 0: { slidesPerView: 1.5, centeredSlides: !0, centeredSlidesBounds: !0 } },
        ...
        e(".brand-active").slick({
            ...
            slidesToScroll: 2,
            responsive: [
                { breakpoint: 1200, settings: { slidesToShow: 5, slidesToScroll: 1, infinite: !0 } },
                { breakpoint: 992, settings: { slidesToShow: 4, slidesToScroll: 1 } },
                { breakpoint: 767, settings: { slidesToShow: 4, slidesToScroll: 1, arrows: !1 } },
                { breakpoint: 575, settings: { slidesToShow: 3, slidesToScroll: 1, arrows: !1 } },
            ],
        }),
    ...
    function d() {
        ...
        e.forEach((e) => {
            ...
            "style4" != s[1] &&
                ...
                "style1" == s[1] && gsap.set(e.split.chars, { opacity: 0, y: "90%", rotateX: "-40deg" }),
    ...
    e(".brand-active .col, .slider__brand-list li").on({
        ...
        !(function s() {
            if (e(".parallax").length) for (var a = document.querySelectorAll(".parallax"), t = 0; t < a.length; t++) new Parallax(a[t], { relativeInput: !0, hoverOnly: !0, selector: ".tg-layer", pointerEvents: !0 });
        })(),
        ...
        (n = e(".tg-parallax")).length &&
            n.each(function () {
                ...
                new simpleParallax(s[0], { scale: a, orientation: t, delay: 1, overflow: !0, transition: "cubic-bezier(0,0,0,1)" });
            }),
